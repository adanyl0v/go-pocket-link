...
func (r *SessionsRepository) Save(ctx context.Context, session *domain.Session) error {
	query := `INSERT INTO sessions (user_id, refresh_token, expires_at) VALUES (:user_id, :refresh_token, :expires_at) RETURNING id`
...
func (r *SessionsRepository) GetByID(ctx context.Context, dest *domain.Session) error {
	...
	return r.db.Get(ctx, dest, query)
}
...
func (r *SessionsRepository) DeleteByID(ctx context.Context, id uuid.UUID) error {
